...
#ifndef ____x_ABI_COrbit_CIMainWindow_FWD_DEFINED__
#define ____x_ABI_COrbit_CIMainWindow_FWD_DEFINED__
namespace ABI {
    namespace Orbit {
        interface IMainWindow;
    } /* Orbit */
} /* ABI */
#define __x_ABI_COrbit_CIMainWindow ABI::Orbit::IMainWindow

#endif // ____x_ABI_COrbit_CIMainWindow_FWD_DEFINED__
...
/*
 *
 * Interface Orbit.IMainWindow
 *
 * Interface is a part of the implementation of type Orbit.MainWindow
 *
 *
 * The IID for this interface was automatically generated by MIDLRT.
 *
 * Interface IID generation seed: Orbit.IMainWindow:HRESULT get_MyProperty(Int32*);HRESULT put_MyProperty(Int32);
 *
 *
 */
#if !defined(____x_ABI_COrbit_CIMainWindow_INTERFACE_DEFINED__)
#define ____x_ABI_COrbit_CIMainWindow_INTERFACE_DEFINED__
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_Orbit_IMainWindow[] = L"Orbit.IMainWindow";
namespace ABI {
    namespace Orbit {
        /* [uuid("a85d86e5-8a47-5a90-aa8b-73b47d185cbe"), version, object, exclusiveto] */
        MIDL_INTERFACE("a85d86e5-8a47-5a90-aa8b-73b47d185cbe")
...
EXTERN_C const IID IID___x_ABI_COrbit_CIMainWindow;
#endif /* !defined(____x_ABI_COrbit_CIMainWindow_INTERFACE_DEFINED__) */


/*
 *
 * Class Orbit.MainWindow
 *
 * RuntimeClass can be activated.
 *
 * Class implements the following interfaces:
 *    Orbit.IMainWindow ** Default Interface **
 *
...
#ifndef RUNTIMECLASS_Orbit_MainWindow_DEFINED
#define RUNTIMECLASS_Orbit_MainWindow_DEFINED
extern const __declspec(selectany) _Null_terminated_ WCHAR RuntimeClass_Orbit_MainWindow[] = L"Orbit.MainWindow";
#endif
...
#ifndef ____x_ABI_COrbit_CIMainWindow_FWD_DEFINED__
#define ____x_ABI_COrbit_CIMainWindow_FWD_DEFINED__
typedef interface __x_ABI_COrbit_CIMainWindow __x_ABI_COrbit_CIMainWindow;
...
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_Orbit_IMainWindow[] = L"Orbit.IMainWindow";
/* [uuid("a85d86e5-8a47-5a90-aa8b-73b47d185cbe"), version, object, exclusiveto] */
typedef struct __x_ABI_COrbit_CIMainWindowVtbl
{
    BEGIN_INTERFACE
    HRESULT ( STDMETHODCALLTYPE *QueryInterface)(
    __RPC__in __x_ABI_COrbit_CIMainWindow * This,
...
/* [propget] */HRESULT ( STDMETHODCALLTYPE *get_MyProperty )(
        __x_ABI_COrbit_CIMainWindow * This,
        /* [out, retval] */int * value
        );
...
} __x_ABI_COrbit_CIMainWindowVtbl;

interface __x_ABI_COrbit_CIMainWindow
{
    CONST_VTBL struct __x_ABI_COrbit_CIMainWindowVtbl *lpVtbl;
};

#ifdef COBJMACROS
#define __x_ABI_COrbit_CIMainWindow_QueryInterface(This,riid,ppvObject) \
( (This)->lpVtbl->QueryInterface(This,riid,ppvObject) )

#define __x_ABI_COrbit_CIMainWindow_AddRef(This) \
        ( (This)->lpVtbl->AddRef(This) )

#define __x_ABI_COrbit_CIMainWindow_Release(This) \
        ( (This)->lpVtbl->Release(This) )

#define __x_ABI_COrbit_CIMainWindow_GetIids(This,iidCount,iids) \
        ( (This)->lpVtbl->GetIids(This,iidCount,iids) )

#define __x_ABI_COrbit_CIMainWindow_GetRuntimeClassName(This,className) \
        ( (This)->lpVtbl->GetRuntimeClassName(This,className) )

#define __x_ABI_COrbit_CIMainWindow_GetTrustLevel(This,trustLevel) \
        ( (This)->lpVtbl->GetTrustLevel(This,trustLevel) )

#define __x_ABI_COrbit_CIMainWindow_get_MyProperty(This,value) \
    ( (This)->lpVtbl->get_MyProperty(This,value) )

#define __x_ABI_COrbit_CIMainWindow_put_MyProperty(This,value) \
