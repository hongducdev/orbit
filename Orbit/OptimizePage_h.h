/* Header file automatically generated from OptimizePage.idl */
/*
...
#ifndef __OptimizePage_h_h__
#define __OptimizePage_h_h__
#ifndef __OptimizePage_h_p_h__
#define __OptimizePage_h_p_h__
...
#ifndef ____x_ABI_COrbit_CIOptimizePage_FWD_DEFINED__
#define ____x_ABI_COrbit_CIOptimizePage_FWD_DEFINED__
namespace ABI {
    namespace Orbit {
        interface IOptimizePage;
    } /* Orbit */
} /* ABI */
#define __x_ABI_COrbit_CIOptimizePage ABI::Orbit::IOptimizePage

#endif // ____x_ABI_COrbit_CIOptimizePage_FWD_DEFINED__
...
/*
 *
 * Interface Orbit.IOptimizePage
 *
 * Interface is a part of the implementation of type Orbit.OptimizePage
 *
 *
 * The IID for this interface was automatically generated by MIDLRT.
 *
 * Interface IID generation seed: Orbit.IOptimizePage:
 *
 *
 */
#if !defined(____x_ABI_COrbit_CIOptimizePage_INTERFACE_DEFINED__)
#define ____x_ABI_COrbit_CIOptimizePage_INTERFACE_DEFINED__
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_Orbit_IOptimizePage[] = L"Orbit.IOptimizePage";
namespace ABI {
    namespace Orbit {
        /* [uuid("e9826276-2b01-51c9-b110-fc1ec8c12eee"), version, object, exclusiveto] */
        MIDL_INTERFACE("e9826276-2b01-51c9-b110-fc1ec8c12eee")
        IOptimizePage : public IInspectable
        {
        public:
            
        };

        MIDL_CONST_ID IID & IID_IOptimizePage=__uuidof(IOptimizePage);
        
    } /* Orbit */
} /* ABI */

EXTERN_C const IID IID___x_ABI_COrbit_CIOptimizePage;
#endif /* !defined(____x_ABI_COrbit_CIOptimizePage_INTERFACE_DEFINED__) */


/*
 *
 * Class Orbit.OptimizePage
 *
 * RuntimeClass can be activated.
 *
 * Class implements the following interfaces:
 *    Orbit.IOptimizePage ** Default Interface **
 *
...
#ifndef RUNTIMECLASS_Orbit_OptimizePage_DEFINED
#define RUNTIMECLASS_Orbit_OptimizePage_DEFINED
extern const __declspec(selectany) _Null_terminated_ WCHAR RuntimeClass_Orbit_OptimizePage[] = L"Orbit.OptimizePage";
#endif
...
#ifndef ____x_ABI_COrbit_CIOptimizePage_FWD_DEFINED__
#define ____x_ABI_COrbit_CIOptimizePage_FWD_DEFINED__
typedef interface __x_ABI_COrbit_CIOptimizePage __x_ABI_COrbit_CIOptimizePage;
...
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_Orbit_IOptimizePage[] = L"Orbit.IOptimizePage";
/* [uuid("e9826276-2b01-51c9-b110-fc1ec8c12eee"), version, object, exclusiveto] */
typedef struct __x_ABI_COrbit_CIOptimizePageVtbl
{
    BEGIN_INTERFACE
    HRESULT ( STDMETHODCALLTYPE *QueryInterface)(
    __RPC__in __x_ABI_COrbit_CIOptimizePage * This,
...
} __x_ABI_COrbit_CIOptimizePageVtbl;

interface __x_ABI_COrbit_CIOptimizePage
{
    CONST_VTBL struct __x_ABI_COrbit_CIOptimizePageVtbl *lpVtbl;
};

#ifdef COBJMACROS
#define __x_ABI_COrbit_CIOptimizePage_QueryInterface(This,riid,ppvObject) \
( (This)->lpVtbl->QueryInterface(This,riid,ppvObject) )

#define __x_ABI_COrbit_CIOptimizePage_AddRef(This) \
        ( (This)->lpVtbl->AddRef(This) )

#define __x_ABI_COrbit_CIOptimizePage_Release(This) \
        ( (This)->lpVtbl->Release(This) )

#define __x_ABI_COrbit_CIOptimizePage_GetIids(This,iidCount,iids) \
        ( (This)->lpVtbl->GetIids(This,iidCount,iids) )

#define __x_ABI_COrbit_CIOptimizePage_GetRuntimeClassName(This,className) \
        ( (This)->lpVtbl->GetRuntimeClassName(This,className) )

#define __x_ABI_COrbit_CIOptimizePage_GetTrustLevel(This,trustLevel) \
...
#endif // __OptimizePage_h_p_h__

#endif // __OptimizePage_h_h__
