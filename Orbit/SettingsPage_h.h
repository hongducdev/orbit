/* Header file automatically generated from SettingsPage.idl */
/*
...
#ifndef __SettingsPage_h_h__
#define __SettingsPage_h_h__
#ifndef __SettingsPage_h_p_h__
#define __SettingsPage_h_p_h__
...
#ifndef ____x_ABI_COrbit_CISettingsPage_FWD_DEFINED__
#define ____x_ABI_COrbit_CISettingsPage_FWD_DEFINED__
namespace ABI {
    namespace Orbit {
        interface ISettingsPage;
    } /* Orbit */
} /* ABI */
#define __x_ABI_COrbit_CISettingsPage ABI::Orbit::ISettingsPage

#endif // ____x_ABI_COrbit_CISettingsPage_FWD_DEFINED__
...
/*
 *
 * Interface Orbit.ISettingsPage
 *
 * Interface is a part of the implementation of type Orbit.SettingsPage
 *
 *
 * The IID for this interface was automatically generated by MIDLRT.
 *
 * Interface IID generation seed: Orbit.ISettingsPage:
 *
 *
 */
#if !defined(____x_ABI_COrbit_CISettingsPage_INTERFACE_DEFINED__)
#define ____x_ABI_COrbit_CISettingsPage_INTERFACE_DEFINED__
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_Orbit_ISettingsPage[] = L"Orbit.ISettingsPage";
namespace ABI {
    namespace Orbit {
        /* [uuid("f557feac-1480-556f-aedd-ca2953f2d3cb"), version, object, exclusiveto] */
        MIDL_INTERFACE("f557feac-1480-556f-aedd-ca2953f2d3cb")
        ISettingsPage : public IInspectable
        {
        public:
            
        };

        MIDL_CONST_ID IID & IID_ISettingsPage=__uuidof(ISettingsPage);
        
    } /* Orbit */
} /* ABI */

EXTERN_C const IID IID___x_ABI_COrbit_CISettingsPage;
#endif /* !defined(____x_ABI_COrbit_CISettingsPage_INTERFACE_DEFINED__) */


/*
 *
 * Class Orbit.SettingsPage
 *
 * RuntimeClass can be activated.
 *
 * Class implements the following interfaces:
 *    Orbit.ISettingsPage ** Default Interface **
 *
...
#ifndef RUNTIMECLASS_Orbit_SettingsPage_DEFINED
#define RUNTIMECLASS_Orbit_SettingsPage_DEFINED
extern const __declspec(selectany) _Null_terminated_ WCHAR RuntimeClass_Orbit_SettingsPage[] = L"Orbit.SettingsPage";
#endif
...
#ifndef ____x_ABI_COrbit_CISettingsPage_FWD_DEFINED__
#define ____x_ABI_COrbit_CISettingsPage_FWD_DEFINED__
typedef interface __x_ABI_COrbit_CISettingsPage __x_ABI_COrbit_CISettingsPage;
...
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_Orbit_ISettingsPage[] = L"Orbit.ISettingsPage";
/* [uuid("f557feac-1480-556f-aedd-ca2953f2d3cb"), version, object, exclusiveto] */
typedef struct __x_ABI_COrbit_CISettingsPageVtbl
{
    BEGIN_INTERFACE
    HRESULT ( STDMETHODCALLTYPE *QueryInterface)(
    __RPC__in __x_ABI_COrbit_CISettingsPage * This,
...
} __x_ABI_COrbit_CISettingsPageVtbl;

interface __x_ABI_COrbit_CISettingsPage
{
    CONST_VTBL struct __x_ABI_COrbit_CISettingsPageVtbl *lpVtbl;
};

#ifdef COBJMACROS
#define __x_ABI_COrbit_CISettingsPage_QueryInterface(This,riid,ppvObject) \
( (This)->lpVtbl->QueryInterface(This,riid,ppvObject) )

#define __x_ABI_COrbit_CISettingsPage_AddRef(This) \
        ( (This)->lpVtbl->AddRef(This) )

#define __x_ABI_COrbit_CISettingsPage_Release(This) \
        ( (This)->lpVtbl->Release(This) )

#define __x_ABI_COrbit_CISettingsPage_GetIids(This,iidCount,iids) \
        ( (This)->lpVtbl->GetIids(This,iidCount,iids) )

#define __x_ABI_COrbit_CISettingsPage_GetRuntimeClassName(This,className) \
        ( (This)->lpVtbl->GetRuntimeClassName(This,className) )

#define __x_ABI_COrbit_CISettingsPage_GetTrustLevel(This,trustLevel) \
...
#endif // __SettingsPage_h_p_h__

#endif // __SettingsPage_h_h__
