/* Header file automatically generated from SoftwarePage.idl */
/*
...
#ifndef __SoftwarePage_h_h__
#define __SoftwarePage_h_h__
#ifndef __SoftwarePage_h_p_h__
#define __SoftwarePage_h_p_h__
...
#ifndef ____x_ABI_COrbit_CISoftwarePage_FWD_DEFINED__
#define ____x_ABI_COrbit_CISoftwarePage_FWD_DEFINED__
namespace ABI {
    namespace Orbit {
        interface ISoftwarePage;
    } /* Orbit */
} /* ABI */
#define __x_ABI_COrbit_CISoftwarePage ABI::Orbit::ISoftwarePage

#endif // ____x_ABI_COrbit_CISoftwarePage_FWD_DEFINED__
...
/*
 *
 * Interface Orbit.ISoftwarePage
 *
 * Interface is a part of the implementation of type Orbit.SoftwarePage
 *
 *
 * The IID for this interface was automatically generated by MIDLRT.
 *
 * Interface IID generation seed: Orbit.ISoftwarePage:
 *
 *
 */
#if !defined(____x_ABI_COrbit_CISoftwarePage_INTERFACE_DEFINED__)
#define ____x_ABI_COrbit_CISoftwarePage_INTERFACE_DEFINED__
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_Orbit_ISoftwarePage[] = L"Orbit.ISoftwarePage";
namespace ABI {
    namespace Orbit {
        /* [uuid("0bd2e07b-ec73-5329-bdbc-ea1de3ee9a65"), version, object, exclusiveto] */
        MIDL_INTERFACE("0bd2e07b-ec73-5329-bdbc-ea1de3ee9a65")
        ISoftwarePage : public IInspectable
        {
        public:
            
        };

        MIDL_CONST_ID IID & IID_ISoftwarePage=__uuidof(ISoftwarePage);
        
    } /* Orbit */
} /* ABI */

EXTERN_C const IID IID___x_ABI_COrbit_CISoftwarePage;
#endif /* !defined(____x_ABI_COrbit_CISoftwarePage_INTERFACE_DEFINED__) */


/*
 *
 * Class Orbit.SoftwarePage
 *
 * RuntimeClass can be activated.
 *
 * Class implements the following interfaces:
 *    Orbit.ISoftwarePage ** Default Interface **
 *
...
#ifndef RUNTIMECLASS_Orbit_SoftwarePage_DEFINED
#define RUNTIMECLASS_Orbit_SoftwarePage_DEFINED
extern const __declspec(selectany) _Null_terminated_ WCHAR RuntimeClass_Orbit_SoftwarePage[] = L"Orbit.SoftwarePage";
#endif
...
#ifndef ____x_ABI_COrbit_CISoftwarePage_FWD_DEFINED__
#define ____x_ABI_COrbit_CISoftwarePage_FWD_DEFINED__
typedef interface __x_ABI_COrbit_CISoftwarePage __x_ABI_COrbit_CISoftwarePage;
...
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_Orbit_ISoftwarePage[] = L"Orbit.ISoftwarePage";
/* [uuid("0bd2e07b-ec73-5329-bdbc-ea1de3ee9a65"), version, object, exclusiveto] */
typedef struct __x_ABI_COrbit_CISoftwarePageVtbl
{
    BEGIN_INTERFACE
    HRESULT ( STDMETHODCALLTYPE *QueryInterface)(
    __RPC__in __x_ABI_COrbit_CISoftwarePage * This,
...
} __x_ABI_COrbit_CISoftwarePageVtbl;

interface __x_ABI_COrbit_CISoftwarePage
{
    CONST_VTBL struct __x_ABI_COrbit_CISoftwarePageVtbl *lpVtbl;
};

#ifdef COBJMACROS
#define __x_ABI_COrbit_CISoftwarePage_QueryInterface(This,riid,ppvObject) \
( (This)->lpVtbl->QueryInterface(This,riid,ppvObject) )

#define __x_ABI_COrbit_CISoftwarePage_AddRef(This) \
        ( (This)->lpVtbl->AddRef(This) )

#define __x_ABI_COrbit_CISoftwarePage_Release(This) \
        ( (This)->lpVtbl->Release(This) )

#define __x_ABI_COrbit_CISoftwarePage_GetIids(This,iidCount,iids) \
        ( (This)->lpVtbl->GetIids(This,iidCount,iids) )

#define __x_ABI_COrbit_CISoftwarePage_GetRuntimeClassName(This,className) \
        ( (This)->lpVtbl->GetRuntimeClassName(This,className) )

#define __x_ABI_COrbit_CISoftwarePage_GetTrustLevel(This,trustLevel) \
...
#endif // __SoftwarePage_h_p_h__

#endif // __SoftwarePage_h_h__
