/* Header file automatically generated from StatusPage.idl */
/*
...
#ifndef __StatusPage_h_h__
#define __StatusPage_h_h__
#ifndef __StatusPage_h_p_h__
#define __StatusPage_h_p_h__
...
#ifndef ____x_ABI_COrbit_CIStatusPage_FWD_DEFINED__
#define ____x_ABI_COrbit_CIStatusPage_FWD_DEFINED__
namespace ABI {
    namespace Orbit {
        interface IStatusPage;
    } /* Orbit */
} /* ABI */
#define __x_ABI_COrbit_CIStatusPage ABI::Orbit::IStatusPage

#endif // ____x_ABI_COrbit_CIStatusPage_FWD_DEFINED__
...
/*
 *
 * Interface Orbit.IStatusPage
 *
 * Interface is a part of the implementation of type Orbit.StatusPage
 *
 *
 * The IID for this interface was automatically generated by MIDLRT.
 *
 * Interface IID generation seed: Orbit.IStatusPage:
 *
 *
 */
#if !defined(____x_ABI_COrbit_CIStatusPage_INTERFACE_DEFINED__)
#define ____x_ABI_COrbit_CIStatusPage_INTERFACE_DEFINED__
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_Orbit_IStatusPage[] = L"Orbit.IStatusPage";
namespace ABI {
    namespace Orbit {
        /* [uuid("ffae7bca-70b5-5289-a564-fe2b2a5c0bea"), version, object, exclusiveto] */
        MIDL_INTERFACE("ffae7bca-70b5-5289-a564-fe2b2a5c0bea")
        IStatusPage : public IInspectable
        {
        public:
            
        };

        MIDL_CONST_ID IID & IID_IStatusPage=__uuidof(IStatusPage);
        
    } /* Orbit */
} /* ABI */

EXTERN_C const IID IID___x_ABI_COrbit_CIStatusPage;
#endif /* !defined(____x_ABI_COrbit_CIStatusPage_INTERFACE_DEFINED__) */


/*
 *
 * Class Orbit.StatusPage
 *
 * RuntimeClass can be activated.
 *
 * Class implements the following interfaces:
 *    Orbit.IStatusPage ** Default Interface **
 *
...
#ifndef RUNTIMECLASS_Orbit_StatusPage_DEFINED
#define RUNTIMECLASS_Orbit_StatusPage_DEFINED
extern const __declspec(selectany) _Null_terminated_ WCHAR RuntimeClass_Orbit_StatusPage[] = L"Orbit.StatusPage";
#endif
...
#ifndef ____x_ABI_COrbit_CIStatusPage_FWD_DEFINED__
#define ____x_ABI_COrbit_CIStatusPage_FWD_DEFINED__
typedef interface __x_ABI_COrbit_CIStatusPage __x_ABI_COrbit_CIStatusPage;
...
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_Orbit_IStatusPage[] = L"Orbit.IStatusPage";
/* [uuid("ffae7bca-70b5-5289-a564-fe2b2a5c0bea"), version, object, exclusiveto] */
typedef struct __x_ABI_COrbit_CIStatusPageVtbl
{
    BEGIN_INTERFACE
    HRESULT ( STDMETHODCALLTYPE *QueryInterface)(
    __RPC__in __x_ABI_COrbit_CIStatusPage * This,
...
} __x_ABI_COrbit_CIStatusPageVtbl;

interface __x_ABI_COrbit_CIStatusPage
{
    CONST_VTBL struct __x_ABI_COrbit_CIStatusPageVtbl *lpVtbl;
};

#ifdef COBJMACROS
#define __x_ABI_COrbit_CIStatusPage_QueryInterface(This,riid,ppvObject) \
( (This)->lpVtbl->QueryInterface(This,riid,ppvObject) )

#define __x_ABI_COrbit_CIStatusPage_AddRef(This) \
        ( (This)->lpVtbl->AddRef(This) )

#define __x_ABI_COrbit_CIStatusPage_Release(This) \
        ( (This)->lpVtbl->Release(This) )

#define __x_ABI_COrbit_CIStatusPage_GetIids(This,iidCount,iids) \
        ( (This)->lpVtbl->GetIids(This,iidCount,iids) )

#define __x_ABI_COrbit_CIStatusPage_GetRuntimeClassName(This,className) \
        ( (This)->lpVtbl->GetRuntimeClassName(This,className) )

#define __x_ABI_COrbit_CIStatusPage_GetTrustLevel(This,trustLevel) \
...
#endif // __StatusPage_h_p_h__

#endif // __StatusPage_h_h__
