/* Header file automatically generated from AnalyzePage.idl */
/*
...
#ifndef __AnalyzePage_h_h__
#define __AnalyzePage_h_h__
#ifndef __AnalyzePage_h_p_h__
#define __AnalyzePage_h_p_h__
...
#ifndef ____x_ABI_COrbit_CIAnalyzePage_FWD_DEFINED__
#define ____x_ABI_COrbit_CIAnalyzePage_FWD_DEFINED__
namespace ABI {
    namespace Orbit {
        interface IAnalyzePage;
    } /* Orbit */
} /* ABI */
#define __x_ABI_COrbit_CIAnalyzePage ABI::Orbit::IAnalyzePage

#endif // ____x_ABI_COrbit_CIAnalyzePage_FWD_DEFINED__
...
/*
 *
 * Interface Orbit.IAnalyzePage
 *
 * Interface is a part of the implementation of type Orbit.AnalyzePage
 *
 *
 * The IID for this interface was automatically generated by MIDLRT.
 *
 * Interface IID generation seed: Orbit.IAnalyzePage:
 *
 *
 */
#if !defined(____x_ABI_COrbit_CIAnalyzePage_INTERFACE_DEFINED__)
#define ____x_ABI_COrbit_CIAnalyzePage_INTERFACE_DEFINED__
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_Orbit_IAnalyzePage[] = L"Orbit.IAnalyzePage";
namespace ABI {
    namespace Orbit {
        /* [uuid("1503f4f9-ec0e-5dbc-90e6-f57b1f47c70f"), version, object, exclusiveto] */
        MIDL_INTERFACE("1503f4f9-ec0e-5dbc-90e6-f57b1f47c70f")
        IAnalyzePage : public IInspectable
        {
        public:
            
        };

        MIDL_CONST_ID IID & IID_IAnalyzePage=__uuidof(IAnalyzePage);
        
    } /* Orbit */
} /* ABI */

EXTERN_C const IID IID___x_ABI_COrbit_CIAnalyzePage;
#endif /* !defined(____x_ABI_COrbit_CIAnalyzePage_INTERFACE_DEFINED__) */


/*
 *
 * Class Orbit.AnalyzePage
 *
 * RuntimeClass can be activated.
 *
 * Class implements the following interfaces:
 *    Orbit.IAnalyzePage ** Default Interface **
 *
...
#ifndef RUNTIMECLASS_Orbit_AnalyzePage_DEFINED
#define RUNTIMECLASS_Orbit_AnalyzePage_DEFINED
extern const __declspec(selectany) _Null_terminated_ WCHAR RuntimeClass_Orbit_AnalyzePage[] = L"Orbit.AnalyzePage";
#endif
...
#ifndef ____x_ABI_COrbit_CIAnalyzePage_FWD_DEFINED__
#define ____x_ABI_COrbit_CIAnalyzePage_FWD_DEFINED__
typedef interface __x_ABI_COrbit_CIAnalyzePage __x_ABI_COrbit_CIAnalyzePage;
...
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_Orbit_IAnalyzePage[] = L"Orbit.IAnalyzePage";
/* [uuid("1503f4f9-ec0e-5dbc-90e6-f57b1f47c70f"), version, object, exclusiveto] */
typedef struct __x_ABI_COrbit_CIAnalyzePageVtbl
{
    BEGIN_INTERFACE
    HRESULT ( STDMETHODCALLTYPE *QueryInterface)(
    __RPC__in __x_ABI_COrbit_CIAnalyzePage * This,
...
} __x_ABI_COrbit_CIAnalyzePageVtbl;

interface __x_ABI_COrbit_CIAnalyzePage
{
    CONST_VTBL struct __x_ABI_COrbit_CIAnalyzePageVtbl *lpVtbl;
};

#ifdef COBJMACROS
#define __x_ABI_COrbit_CIAnalyzePage_QueryInterface(This,riid,ppvObject) \
( (This)->lpVtbl->QueryInterface(This,riid,ppvObject) )

#define __x_ABI_COrbit_CIAnalyzePage_AddRef(This) \
        ( (This)->lpVtbl->AddRef(This) )

#define __x_ABI_COrbit_CIAnalyzePage_Release(This) \
        ( (This)->lpVtbl->Release(This) )

#define __x_ABI_COrbit_CIAnalyzePage_GetIids(This,iidCount,iids) \
        ( (This)->lpVtbl->GetIids(This,iidCount,iids) )

#define __x_ABI_COrbit_CIAnalyzePage_GetRuntimeClassName(This,className) \
        ( (This)->lpVtbl->GetRuntimeClassName(This,className) )

#define __x_ABI_COrbit_CIAnalyzePage_GetTrustLevel(This,trustLevel) \
...
#endif // __AnalyzePage_h_p_h__

#endif // __AnalyzePage_h_h__
